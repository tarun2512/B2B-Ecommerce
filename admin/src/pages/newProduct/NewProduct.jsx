    ...
    <div className="newProduct">
      ...
      <form className="addProductForm">
        ...
        <div className="addProductItem">
          ...
          <input type="text" placeholder="men,kids" onChange={handleCat} />
        </div>
        <div className="addProductItem">
          <label>Colors</label>
          <input type="text" placeholder="red,blue" onChange={handleCol} />
        </div>
        <div className="addProductItem">
          <label>Size</label>
          <input type="text" placeholder="s,m,l" onChange={handleSiz} />
        </div>
        <div className="addProductItem">
          <label>Stock</label>
